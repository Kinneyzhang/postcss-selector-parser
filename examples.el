    ...
    (css-selector-walk ast
      (lambda (node)
        (let ((type (plist-get node :type)))
          (cond
           ((eq type 'tag) (cl-incf (plist-get counts :tags)))
           ((eq type 'class) (cl-incf (plist-get counts :classes)))
           ((eq type 'id) (cl-incf (plist-get counts :ids)))
           ((eq type 'pseudo) (cl-incf (plist-get counts :pseudos)))
           ((eq type 'combinator) (cl-incf (plist-get counts :combinators)))))))
    counts))
